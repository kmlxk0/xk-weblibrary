...
/**
 * WebPage 封装来自 webpage 数据表的记录及领域逻辑
 */
class WebPage extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                // 主键应该是只读，确保领域对象的“不变量”
                'webpage_id' => array('readonly' => true),
                ...
                'tags'=> array(QDB::MANY_TO_MANY => 'WebPageTag', 'source_key' => 'tag_id', 'target_key' => 'tag_id'),
                //标签
                'tags' => array(
                        QDB::MANY_TO_MANY=> 'Tag',
                        'mid_source_key' => 'webpage_id',
                        'mid_target_key' => 'tag_id',
                        'mid_table_name' => 'webpage_tag'
                ),
            ...
            (
                'title' => array
                (
                    array('max_length', 200, 'title不能超过 200 个字符'),
