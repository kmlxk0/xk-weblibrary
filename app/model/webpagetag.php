...
/**
 * WebpageTag 封装来自 webpage_tag 数据表的记录及领域逻辑
 */
class WebpageTag extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'tag_id' => array
                (
                    array('is_int', 'tag_id必须是一个整数'),

                ),

                'webpage_id' => array
                (
                    array('is_int', 'webpage_id必须是一个整数'),
